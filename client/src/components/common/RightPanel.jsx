...
const RightPanel = () => {
	...
	return (
		<aside
			className={`relative min-h-[calc(100vh-4rem)] bg-[#0A0F1F]/30 backdrop-blur-sm border-l border-white/5 p-4 overflow-y-auto sticky top-16 transition-all duration-300 ${
